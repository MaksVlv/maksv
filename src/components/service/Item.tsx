            ...
            <div className={"relative"}  style={{ width: (index !== undefined ? "30%" : "100%"), height: "200px" }}>
                ...
                {index !== undefined &&
                    <div style={{ position: "absolute", bottom: "5px", right: "5px", width: "50px", height: "50px", borderRadius: "50%", backgroundColor: "grey", display: "flex", justifyContent: "center", alignItems: "center" }} >
                        <svg onClick={() => { console.log(1); if (index !== undefined && onDelete) onDelete(index)}} style={{ position: "relative", right: "-0.5px", fill: "#1E1E1E" }} className={styles.delete} xmlns="http://www.w3.org/2000/svg" fill={"none"} width="25" height="25" viewBox="0 0 25 25">
